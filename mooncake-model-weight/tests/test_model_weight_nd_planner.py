...
from mooncake.model_weight.planner import TransferRegion, plan_runtime_transfer
            ...
            for component_index, component in enumerate(component_order):
                ...
                fragments.extend(
                    (
                        RuntimeFragment(
                            fragment_id=(
                                f"{worker_id}-expert{expert_id}-{component}-weight"
                            ),
                        ...
                        RuntimeFragment(
                            fragment_id=(
                                f"{worker_id}-expert{expert_id}-{component}-scale"
                            ),
