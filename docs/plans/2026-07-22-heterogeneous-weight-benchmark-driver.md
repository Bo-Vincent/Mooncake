...
**Files:**
- Create: `mooncake-model-weight/benchmarks/heterogeneous_weight_reshard/__init__.py`
- Create: `mooncake-model-weight/benchmarks/heterogeneous_weight_reshard/case_spec.py`
- Create: `mooncake-model-weight/benchmarks/heterogeneous_weight_reshard/tests/test_case_spec.py`
...
```bash
PYTHONPATH=mooncake-wheel:mooncake-model-weight/python:mooncake-model-weight \
python3 -m pytest -q \
  mooncake-model-weight/benchmarks/heterogeneous_weight_reshard/tests/test_case_spec.py
```
...
**Files:**
- Create: `mooncake-model-weight/benchmarks/heterogeneous_weight_reshard/m2n_adapter.py`
- Create: `mooncake-model-weight/benchmarks/heterogeneous_weight_reshard/tests/test_m2n_adapter.py`
...
**Files:**
- Create: `mooncake-model-weight/benchmarks/heterogeneous_weight_reshard/mooncake_adapter.py`
- Create: `mooncake-model-weight/benchmarks/heterogeneous_weight_reshard/tests/test_mooncake_adapter.py`
...
Construct v2 `TensorDescriptor`, one `RuntimeManifest` per logical rank and stable fake
fragments, call `plan_runtime_transfer`, then summarize operations without iterating
individual segments. Never instantiate a transfer engine.
...
**Files:**
- Create: `mooncake-model-weight/benchmarks/heterogeneous_weight_reshard/__main__.py`
- Create: `mooncake-model-weight/benchmarks/heterogeneous_weight_reshard/cases.json`
- Create: `mooncake-model-weight/benchmarks/heterogeneous_weight_reshard/tests/test_cli.py`
...
**Files:**
- Create: `mooncake-model-weight/benchmarks/heterogeneous_weight_reshard/README.md`
...
**Files:**
- Review all files under `mooncake-model-weight/benchmarks/heterogeneous_weight_reshard/`
