...
DeserializeStandbyObjectMetadata(
    ...
    try {
        ...
        //   hard_pinned (bool), group_id (str), and residency affinity (str)
        //   trail them.
        ...
        //   v6: 11 + replica_count, v4 + residency_affinity_id
        //   v7: 12 + replica_count, v6 + object_checksum (ignored here)
        ...
        metadata.residency_affinity_id = std::move(residency_affinity_id);
