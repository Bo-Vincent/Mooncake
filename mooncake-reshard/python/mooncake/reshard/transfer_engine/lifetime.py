"""Execution-only allocation lifetime contracts.

These objects deliberately stay outside placement manifests and serialized
plans. Framework adapters own the actual allocator pin; the transfer executor
only verifies the returned fence and releases it after terminal completion.
"""
...
class AllocationFence:
    ...
    def __post_init__(self) -> None:
        ...
        if not fragment_ids or any(type(value) is not str or not value for value in fragment_ids):
