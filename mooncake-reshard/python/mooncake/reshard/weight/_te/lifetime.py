...
from ...transfer_engine.lifetime import (
    AllocationFence,
...
WeightAllocationGuardProviders = Mapping[GuardProviderKey, WeightAllocationGuardProvider]
    ...
    *,
    ...
    try:
        for key in sorted(binding_by_key):
            ...
            _validate_acquired_binding(expected_binding, fresh_binding, required_fragment_ids)
...
def weight_allocation_fence(
    ...
    *,
    ...
    if missing:
        raise ValueError(f"runtime binding is missing guarded fragments: {sorted(missing)}")
